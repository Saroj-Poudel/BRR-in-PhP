...
// Use the session id to retrieve the correct id from booked_userdetails
$registration_id = $_SESSION["id"];

// Fetch the id from booked_userdetails based on the registration_id
$sql = "SELECT id FROM booked_userdetails WHERE registration_id = ?";
...
if ($result->num_rows > 0) {
    ...
    // Fetch package details for the logged-in user using the retrieved id
    ...
    echo "No booked user details found for the given registration ID.";
    exit();
}
